...
<head>
    ...
    <title>Binfung Propam - Change Password</title>
    <!-- Favicon icon -->
                            ...
                            <div class="card-body pt-5">
                                ...
                                @if (Session::has('new_password'))
                                    <p class="alert alert-info mt-2">
                                        Update Password, Password tidak boleh default!</p>
                                @endif
                                ...
                                @if (Session::has('error'))
                                    <p class="alert alert-danger mt-2">
                                        {{ Session::get('error') }}</p>
                                @endif
                                <form class="mt-5 mb-5 login-input" action="{{ route('change_password.post') }}"
                                    method="post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control"
                                            placeholder="Tulis Ulang Password Baru" name="repassword">
                                    </div>
