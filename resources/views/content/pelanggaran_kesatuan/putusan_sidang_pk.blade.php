                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body pb-0 d-flex justify-content-between">
                                <div>
                                    <h4 class="mb-1">Putusan Sidang Peninjauan Kembali</h4>
                                </div>
                                <div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="/pelanggaran-data/sidang_pk/{{ $id }}/save" method="post">
                                    @csrf
                                    ...
                                    <div id="sidang_div">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Put Sidang PK</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control putusan" id="putusan_sidang_banding"
                                                style="width: 100%" name="putusan_sidang_pk">
                                                <option value="">Pilih</option>
                                                <option value="Menguatkan Sanksi Putusan Sidang KEPP Atau KEPP Banding"
                                                    {{ $sidang_banding ? ($sidang_banding->putusan_sidang_pk == 'Menguatkan Sanksi Putusan Sidang KEPP Atau KEPP Banding' ? 'selected' : '') : '' }}>
                                                    Menguatkan Sanksi Putusan Sidang KEPP Atau KEPP Banding
                                                </option>
                                                <option value="Memberatkan Sanksi Putusan Sidang KEPP Atau KEPP Banding"
                                                    {{ $sidang_banding ? ($sidang_banding->putusan_sidang_pk == 'Memberatkan Sanksi Putusan Sidang KEPP Atau KEPP Banding' ? 'selected' : '') : '' }}>
                                                    Memberatkan Sanksi Putusan Sidang KEPP Atau KEPP Banding
                                                </option>
                                                <option value="Pengurangan Sanksi Putusan Sidang KEPP Atau KEPP Banding"
                                                    {{ $sidang_banding ? ($sidang_banding->putusan_sidang_pk == 'Pengurangan Sanksi Putusan Sidang KEPP Atau KEPP Banding' ? 'selected' : '') : '' }}>
                                                    Pengurangan Sanksi Putusan Sidang KEPP Atau KEPP Banding
                                                </option>
                                                <option value="Pembebasan Dari Penjatuhan Sanksi KEPP Atau KEPP Banding"
                                                    {{ $sidang_banding ? ($sidang_banding->putusan_sidang_pk == 'Pembebasan Dari Penjatuhan SanksiPembebasan Dari Penjatuhan Sanksi KEPP Atau KEPP Banding' ? 'selected' : '') : '' }}>
                                                    Pengurangan Sanksi Putusan Sidang KEPP Atau KEPP Banding
                                                </option>
                                            </select>
                                        </div>
